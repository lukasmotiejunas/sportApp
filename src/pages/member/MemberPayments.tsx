...
export default function MemberPayments() {
  ...
  const history = [
    ...
    {
      id: "h2",
      month: "Praėjusį mėnesį",
      status: "paid" as const,
      date: addDays(member.lastPaymentDate, -30),
      amount: plan.monthlyFee,
    },
    {
      id: "h3",
      month: "Prieš 2 mėnesius",
      status: "paid" as const,
      date: addDays(member.lastPaymentDate, -60),
      amount: plan.monthlyFee,
    },
    {
      id: "h4",
      month: "Prieš 3 mėnesius",
      status: "paid" as const,
      date: addDays(member.lastPaymentDate, -90),
      amount: plan.monthlyFee,
    },
  ];
  ...
  const doPay = () => {
    ...
    push({
      kind: "success",
      message: "Prototipo mokėjimas atliktas — narystė pratęsta.",
    });
  };
    ...
    <div>
        ...
        <div className="mb-3 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-ink-500">
              Mokama kiekvieno mėnesio 1 dieną
            </p>
          </div>
      ...
      >
        <div className="rounded-2xl border border-dashed border-amber-300 bg-amber-50 p-3 text-xs font-medium text-amber-900 dark:border-amber-500/30 dark:bg-amber-500/10 dark:text-amber-100">
          ...
          Prototipo simuliacija — jokia kortelė neapdorojama ir jokie pinigai
          nepervedami.
        </div>
        <div className="mt-4 space-y-2">
          {[
            ...
            {
              id: "sepa",
              label: "SEPA tiesioginis debetas",
              hint: "LT12 xxxx xxxx 4242",
            },
