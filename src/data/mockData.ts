...
export const membershipPlans: MembershipPlan[] = [
  { id: 'plan-unlimited', name: 'Neribotas bėgimo klubas', monthlyFee: 49, currency: 'EUR' },
  { id: 'plan-lite', name: 'Savaitgalio bėgikas', monthlyFee: 29, currency: 'EUR' },
];
...
const memberSeeds: Array<Partial<Member> & { id: string; name: string; gender: Member['gender']; ageGroup: string }> = [
  { id: 'm-alex', name: 'Alex Morgan', gender: 'female', ageGroup: 'Suaugusiųjų', preferredDistance: '100 m sprintas', paymentStatus: 'paid' },
  { id: 'm-jamie', name: 'Jamie Chen', gender: 'male', ageGroup: 'Suaugusiųjų', preferredDistance: '5 km', paymentStatus: 'paid' },
  { id: 'm-sam', name: 'Samira Okafor', gender: 'female', ageGroup: 'Suaugusiųjų', preferredDistance: '400 m', paymentStatus: 'paid' },
  { id: 'm-lucas', name: 'Lucas Bernard', gender: 'male', ageGroup: 'Veteranai 40+', preferredDistance: '10 km', paymentStatus: 'paid' },
  { id: 'm-mia', name: 'Mia Johansson', gender: 'female', ageGroup: 'Suaugusiųjų', preferredDistance: '200 m', paymentStatus: 'paid' },
  { id: 'm-david', name: 'David Park', gender: 'male', ageGroup: 'Suaugusiųjų', preferredDistance: '5 km', paymentStatus: 'overdue' },
  { id: 'm-nora', name: 'Nora Fischer', gender: 'female', ageGroup: 'Suaugusiųjų', preferredDistance: '1 km', paymentStatus: 'paid' },
  { id: 'm-jonas', name: 'Jonas Weber', gender: 'male', ageGroup: 'Suaugusiųjų', preferredDistance: '100 m sprintas', paymentStatus: 'paid' },
  { id: 'm-priya', name: 'Priya Kapoor', gender: 'female', ageGroup: 'Suaugusiųjų', preferredDistance: '10 km', paymentStatus: 'paid' },
  { id: 'm-tomas', name: 'Tomas Lindqvist', gender: 'male', ageGroup: 'Veteranai 40+', preferredDistance: '5 km', paymentStatus: 'paid' },
  { id: 'm-yuki', name: 'Yuki Tanaka', gender: 'female', ageGroup: 'Suaugusiųjų', preferredDistance: '60 m', paymentStatus: 'paid' },
  { id: 'm-omar', name: 'Omar Haddad', gender: 'male', ageGroup: 'Suaugusiųjų', preferredDistance: '400 m', paymentStatus: 'paid' },
  { id: 'm-clara', name: 'Clara Rossi', gender: 'female', ageGroup: 'Jauniai', preferredDistance: '100 m sprintas', paymentStatus: 'paid' },
  { id: 'm-noah', name: 'Noah Larsen', gender: 'male', ageGroup: 'Suaugusiųjų', preferredDistance: '5 km', paymentStatus: 'paid' },
  { id: 'm-isla', name: 'Isla Murphy', gender: 'female', ageGroup: 'Suaugusiųjų', preferredDistance: '1 km', paymentStatus: 'overdue' },
  { id: 'm-diego', name: 'Diego Alvarez', gender: 'male', ageGroup: 'Suaugusiųjų', preferredDistance: '200 m', paymentStatus: 'paid' },
  { id: 'm-hana', name: 'Hana Novak', gender: 'female', ageGroup: 'Veteranai 40+', preferredDistance: '10 km', paymentStatus: 'paid' },
  { id: 'm-erik', name: 'Erik Sundberg', gender: 'male', ageGroup: 'Suaugusiųjų', preferredDistance: '100 m sprintas', paymentStatus: 'paid' },
  { id: 'm-fatima', name: 'Fatima Ndiaye', gender: 'female', ageGroup: 'Suaugusiųjų', preferredDistance: '400 m', paymentStatus: 'paid' },
  { id: 'm-leo', name: 'Leo Kowalski', gender: 'male', ageGroup: 'Jauniai', preferredDistance: '60 m', paymentStatus: 'paid' },
];
...
export const members: Member[] = memberSeeds.map((seed, i) => {
  ...
  return {
    ...
    initials,
    emergencyContact: 'Šeimos kontaktas · +370 60000000',
